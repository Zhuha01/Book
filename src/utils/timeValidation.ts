...
export function parseTimeRange(startInput: unknown, endInput: unknown): TimeRangeResult {
  ...
  if (isNaN(start.getTime()) || isNaN(end.getTime())) {
    return {
      ok: false,
      message: 'Invalid start_time or end_time format. Use ISO 8601, e.g. 2026-06-20T10:00:00.000Z',
    };
  }
